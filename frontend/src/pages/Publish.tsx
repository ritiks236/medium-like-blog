...
export const Publish = () => {
    ...
    return(
        <div>
            ...
            }} className="mt-6 inline-flex items-center px-5 py-2.5 text-sm font-medium text-center 
                text-white bg-[#845eed] hover:bg-[#5232a9] rounded-lg focus:ring-4 focus:ring-blue-200 
